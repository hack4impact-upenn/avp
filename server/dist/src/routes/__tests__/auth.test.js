...
describe('testing authentication routes', () => {
    describe('standalone calls to routes', () => {
        describe('/register', () => {
            it('registering returns 201 CREATED', () => __awaiter(void 0, void 0, void 0, function* () {
                ...
                expect(user === null || user === void 0 ? void 0 : user.email).toBe(testEmail);
                expect(user === null || user === void 0 ? void 0 : user.firstName).toBe(testFirstName);
                expect(user === null || user === void 0 ? void 0 : user.lastName).toBe(testLastName);
            }));
        });
        describe('/login', () => {
            it('login before register returns 401 UNAUTHORIZED', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        describe('/logout', () => {
            it('logging out before register + login returns 401 UNAUTHORIZED', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    describe('once registered', () => {
        ...
        it('logging in with incorect credentials returns 401 UNAUTHORIZED', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('registering with the same email returns 400 BAD_REQUEST', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        it('logging out before login returns 401 UNAUTHORIZED', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield agent.post('/api/auth/logout');
            expect(response.status).toBe(statusCode_1.default.UNAUTHORIZED);
            expect(yield session_model_1.default.countDocuments()).toBe(0);
        }));
        it('logging in with correct credentials returns 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            // Login user
            const response = yield agent.post('/api/auth/login').send({
                email: testEmail,
                password: testPassword,
    ...
    describe('once logged in', () => {
        ...
        it('logging in again returns 400 BAD_REQUEST', () => __awaiter(void 0, void 0, void 0, function* () {
            // Login again
            const response = yield agent.post('/api/auth/login').send({
                email: testEmail,
                password: testPassword,
        ...
        it('registering any user returns 400 BAD_REQUEST', () => __awaiter(void 0, void 0, void 0, function* () {
            const response = yield agent.post('/api/auth/register').send({
        ...
        it('logging out returns 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            // Logout user
            const response = yield agent.post('/api/auth/logout');
            expect(response.status).toBe(statusCode_1.default.OK);
            expect(yield session_model_1.default.countDocuments()).toBe(0);
        }));
        it('logging out and logging in with correct credentials returns 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            // Logout user
        ...
        it('logging out then register+login with new email returns 200 OK', () => __awaiter(void 0, void 0, void 0, function* () {
            // Logout user
            let response = yield agent.post('/api/auth/logout');
            expect(response.status).toBe(statusCode_1.default.OK);
            expect(yield session_model_1.default.countDocuments()).toBe(0);
