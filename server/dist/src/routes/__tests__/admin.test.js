...
describe('testing admin routes', () => {
  describe('testing admin routes as admin', () => {
    ...
    beforeEach(() =>
      __awaiter(void 0, void 0, void 0, function* () {
        ...
        expect(response.status).toBe(statusCode_1.default.CREATED);
        expect(
          yield user_model_1.User.findOne({ email: testEmail2 }),
        ).toBeTruthy();
        expect(yield session_model_1.default.countDocuments()).toBe(0);
        response = yield agent.post('/api/auth/register').send({
          email: testEmail3,
        ...
        expect(response.status).toBe(statusCode_1.default.CREATED);
        expect(
          yield user_model_1.User.findOne({ email: testEmail3 }),
        ).toBeTruthy();
        expect(yield session_model_1.default.countDocuments()).toBe(0);
        response = yield agent.post('/api/auth/register').send({
          email: testEmail4,
        ...
        expect(response.status).toBe(statusCode_1.default.CREATED);
        expect(
          yield user_model_1.User.findOne({ email: testEmail4 }),
        ).toBeTruthy();
        expect(yield session_model_1.default.countDocuments()).toBe(0);
    ...
    describe('testing GET /api/admin/adminstatus', () => {
      it('admin calling /adminstatus is true', () =>
        __awaiter(void 0, void 0, void 0, function* () {
          // check admin status
    ...
    describe('testing PUT /api/admin/promote', () => {
      it('admin can promote user', () =>
        __awaiter(void 0, void 0, void 0, function* () {
          ...
          expect(response.status).toBe(statusCode_1.default.OK);
          const newAdmin = yield user_model_1.User.findOne({
            email: testEmail2,
          });
          expect(newAdmin).toBeTruthy();
          expect(newAdmin.admin).toBeTruthy();
        }));
      it('admin promoting non-existant user throws error', () =>
        __awaiter(void 0, void 0, void 0, function* () {
          // promote user
          const response = yield agent
            .put('/api/admin/promote')
      ...
      it('admin promoting self throws error', () =>
        __awaiter(void 0, void 0, void 0, function* () {
          // promote user
          const response = yield agent
            .put('/api/admin/promote')
      ...
      it('admin promoting admin throws error', () =>
        __awaiter(void 0, void 0, void 0, function* () {
          // promote user
          const response = yield agent
            .put('/api/admin/promote')
      ...
      it('promoting without sending body throws email', () =>
        __awaiter(void 0, void 0, void 0, function* () {
          // promote user
    ...
    describe('testing DELETE /api/admin/:email', () => {
      it('admin deleting user removes user', () =>
        __awaiter(void 0, void 0, void 0, function* () {
          // delete user
      ...
      it('admin attempting to delete self throws error', () =>
        __awaiter(void 0, void 0, void 0, function* () {
      ...
      it('admin attempting to delete other admin throws error', () =>
        __awaiter(void 0, void 0, void 0, function* () {
      ...
      it('deleting non-existent user throws error', () =>
        __awaiter(void 0, void 0, void 0, function* () {
  ...
  describe('testing admin routes as non-admin', () => {
    ...
    describe('testing GET /api/admin/users', () => {
      it('non admin cannot get all users', () =>
        __awaiter(void 0, void 0, void 0, function* () {
          // get all users
          const response = yield agent.get('/api/admin/all').send();
    ...
    describe('testing GET /api/admin/adminstatus', () => {
      it('non admin calling /adminstatus throwsError', () =>
        __awaiter(void 0, void 0, void 0, function* () {
          // check admin status
          const response = yield agent.get('/api/admin/adminstatus').send();
          expect(response.status).toBe(statusCode_1.default.UNAUTHORIZED);
    ...
    describe('testing PUT /api/admin/promote', () => {
      it('nonadmin attempting to promote user throws error', () =>
        __awaiter(void 0, void 0, void 0, function* () {
          // promote user
          const response = yield agent
            .put('/api/admin/promote')
    ...
    describe('testing DELETE /api/admin/:email', () => {
      it('non admin attempting to delete user throws error', () =>
        __awaiter(void 0, void 0, void 0, function* () {
          // delete user
          const response = yield agent
            .delete(`/api/admin/${testEmail4}`)
            .send();
          expect(response.status).toBe(statusCode_1.default.UNAUTHORIZED);
        }));
    });
