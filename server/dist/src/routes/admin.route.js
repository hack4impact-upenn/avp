 ...
 */
router.get('/all', auth_middleware_1.isAuthenticated, admin_middleware_1.isAdmin, admin_controller_1.getAllUsers);
/**
 ...
 */
router.get('/adminstatus', auth_middleware_1.isAuthenticated, admin_middleware_1.isAdmin, auth_controller_1.approve);
/**
 ...
 */
router.put('/promote', auth_middleware_1.isAuthenticated, admin_middleware_1.isAdmin, admin_controller_1.upgradePrivilege);
/**
 ...
 */
router.delete('/:email', auth_middleware_1.isAuthenticated, admin_middleware_1.isAdmin, admin_controller_1.deleteUser);
/**
 * A POST route to invite a new user
 * Expects a JSON body with the following fields:
 * - email (string) - The email to invite the user from
 */
router.post('/invite', auth_middleware_1.isAuthenticated, admin_middleware_1.isAdmin, admin_controller_1.inviteUser);
/**
