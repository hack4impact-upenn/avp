        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (!MongoConnection.instance) {
                ...
                if (process.env.NODE_ENV === 'test') {
                    ...
                    MongoConnection.instance = new MongoConnection(process.env.ATLAS_URI || 'NO ATLAS_URI IN .ENV');
                }
            }
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                mongoose_1.default
                    ...
                    .catch((e) => console.error(`Connection to MongoDB failed at: ${this.mongoUri}. ` +
                ...
                mongoose_1.default.connection.on('error', (err) => {
                    ...
                    if (err.name === 'MongoNetworkError') {
                        setTimeout(() => mongoose_1.default.connect(this.mongoUri, opts), 5000);
                    }
                });
            }
            catch (err) {
    ...
    clearInMemoryCollections() {
        return __awaiter(this, void 0, void 0, function* () {
            if (this.mongoMemoryServer && mongoose_1.default.connection.db) {
                ...
                Object.values(collections).forEach((collection) => __awaiter(this, void 0, void 0, function* () {
