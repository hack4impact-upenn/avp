 ...
 */
declare const createUser: (firstName: string, lastName: string, email: string, password: string) => Promise<(import("../models/user.model").IUser & Required<{
    _id: string;
}>) | null>;
/**
 ...
 */
declare const getUserByEmail: (email: string) => Promise<(import("../models/user.model").IUser & Required<{
    _id: string;
}>) | null>;
/**
 ...
 * @returns The {@link User} or null if the user was not found.
 */
declare const getUserByEmailWithPassword: (email: string) => Promise<(import("../models/user.model").IUser & Required<{
    _id: string;
}>) | null>;
/**
 ...
 * @returns The {@link User} or null if the user was not found.
 */
declare const getUserByVerificationToken: (verificationToken: string) => Promise<(import("../models/user.model").IUser & Required<{
    _id: string;
}>) | null>;
/**
 ...
 * @returns The {@link User} or null if the user was not found.
 */
declare const getUserById: (id: string) => Promise<(import("../models/user.model").IUser & Required<{
    _id: string;
}>) | null>;
/**
 ...
 */
declare const getUserByResetPasswordToken: (resetPasswordToken: string) => Promise<(import("../models/user.model").IUser & Required<{
    _id: string;
}>) | null>;
/**
 * @returns All the {@link User}s in the database without their passwords.
 */
declare const getAllUsersFromDB: () => Promise<(import("../models/user.model").IUser & Required<{
    _id: string;
}>)[]>;
/**
 ...
 */
declare const upgradeUserToAdmin: (id: string) => Promise<(import("../models/user.model").IUser & Required<{
    _id: string;
}>) | null>;
/**
 ...
 */
declare const deleteUserById: (id: string) => Promise<(import("../models/user.model").IUser & Required<{
    _id: string;
}>) | null>;
export { passwordHashSaltRounds, createUser, getUserByEmail, getUserByVerificationToken, getUserById, getUserByEmailWithPassword, getUserByResetPasswordToken, getAllUsersFromDB, upgradeUserToAdmin, deleteUserById, };
