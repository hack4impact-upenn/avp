...
exports.deleteUserById = exports.upgradeUserToAdmin = exports.getAllUsersFromDB = exports.getUserByResetPasswordToken = exports.getUserByEmailWithPassword = exports.getUserById = exports.getUserByVerificationToken = exports.getUserByEmail = exports.createUser = exports.passwordHashSaltRounds = void 0;
/**
...
const createUser = (firstName, lastName, email, password) => __awaiter(void 0, void 0, void 0, function* () {
    const hashedPassword = yield (0, bcrypt_1.hash)(password, passwordHashSaltRounds);
    if (!hashedPassword) {
        return null;
    }
 ...
 * @returns The {@link User} or null if the user was not found.
 */
const getUserByVerificationToken = (verificationToken) => __awaiter(void 0, void 0, void 0, function* () {
...
const getUserById = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield user_model_1.User.findById(id).select(removeSensitiveDataQuery).exec();
    return user;
});
 ...
 */
const getUserByResetPasswordToken = (resetPasswordToken) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAllUsersFromDB = () => __awaiter(void 0, void 0, void 0, function* () {
    const userList = yield user_model_1.User.find({}).select(removeSensitiveDataQuery).exec();
    return userList;
});
 ...
 */
const upgradeUserToAdmin = (id) => __awaiter(void 0, void 0, void 0, function* () {
