...
declare const createNewReferral: (
...
declare const getAllReferrals: () => Promise<
  (IReferral &
    Required<{
      _id: string;
    }>)[]
>;
declare const getAllDepartmentReferrals: (department: string) => Promise<
  (IReferral &
    Required<{
      _id: string;
    }>)[]
>;
declare const getReferralById: (id: string) => Promise<
  IReferral &
    Required<{
      _id: string;
    }>
>;
declare const updateReferralById: (
  id: string,
  status: string,
...
>;
declare const addToCommunicationHistory: (
  id: string,
...
>;
declare const updateCommunicationHistory: (
  id: string,
  index: string,
  dateOfCommunication: Date,
  method: string,
...
>;
declare const deleteCommunicationHistory: (
  id: string,
  index: number,
) => Promise<
  IReferral &
...
>;
declare const getDuplicateReferrals: (
  phoneNumber: string,
  email: string,
) => Promise<
  (IReferral &
...
>;
declare const postVictimServicesOutcome: (
  id: string,
...
>;
declare const postCounsellingServicesOutcome: (
  id: string,
...
>;
declare const postYouthServicesOutcome: (
  id: string,
...
>;
declare const putVictimServicesOutcome: (
  id: string,
  eligibleForAVPVictimServices: boolean,
  sentVCAPInfotoClient: boolean,
  avpAdvocateAssistingWithVCAP: boolean,
...
>;
declare const putCounsellingServicesOutcome: (
  id: string,
  eligibleForAVPCounsellingServices: boolean,
  receivingCrisisCounselling: boolean,
  scheduledIntakeApptForIndividualTherapy: boolean,
...
>;
declare const putYouthServicesOutcome: (
  id: string,
  eligibleForYVOServices: boolean,
  assignedToYVOTherapist: boolean,
  yvoStaffName: string,
...
>;
declare const putReferralFileName: (
  id: string,
  name: string,
  key: string,
  type: string,
...
declare const putFollowUpFileName: (
  id: string,
  name: string,
  key: string,
  type: string,
) => Promise<void>;
declare const putOutreachFileName: (
  id: string,
  name: string,
  key: string,
  type: string,
