...
exports.deleteOutreachFileById =
  exports.deleteFollowUpFileById =
  exports.deleteReferralFileById =
  exports.putOutreachFileName =
  exports.putFollowUpFileName =
  exports.putReferralFileName =
  exports.putYouthServicesOutcome =
  exports.putCounsellingServicesOutcome =
  exports.putVictimServicesOutcome =
  exports.postYouthServicesOutcome =
  exports.postCounsellingServicesOutcome =
  exports.postVictimServicesOutcome =
  exports.getDuplicateReferrals =
  exports.deleteCommunicationHistory =
  exports.updateCommunicationHistory =
  exports.addToCommunicationHistory =
  exports.updateReferralById =
  exports.getReferralById =
  exports.getAllDepartmentReferrals =
  exports.getAllReferrals =
  exports.createNewReferral =
    void 0;
...
const getAllDepartmentReferrals = (department) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const updateReferralById = (
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    return referral_model_1.Referral.findByIdAndUpdate(id, updateQuery, {
      new: true,
    }).exec();
  });
exports.updateReferralById = updateReferralById;
const addToCommunicationHistory = (
  id,
  dateOfCommunication,
  method,
  user,
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    return referral_model_1.Referral.findByIdAndUpdate(
      id,
      {
...
const updateCommunicationHistory = (
  id,
  index,
  dateOfCommunication,
  method,
...
const deleteCommunicationHistory = (id, index) =>
  __awaiter(void 0, void 0, void 0, function* () {
    return referral_model_1.Referral.findByIdAndUpdate(
      id,
      [
...
const getDuplicateReferrals = (phoneNumber, email) =>
  __awaiter(void 0, void 0, void 0, function* () {
...
const postVictimServicesOutcome = (
  id,
...
const postCounsellingServicesOutcome = (
  id,
...
const postYouthServicesOutcome = (
  id,
...
const putVictimServicesOutcome = (
  id,
  eligibleForAVPVictimServices,
  sentVCAPInfotoClient,
  avpAdvocateAssistingWithVCAP,
...
const putCounsellingServicesOutcome = (
  id,
  eligibleForAVPCounsellingServices,
  receivingCrisisCounselling,
  scheduledIntakeApptForIndividualTherapy,
...
const putReferralFileName = (id, name, key, type) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const updateItem = {};
...
const deleteReferralFileById = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    yield referral_model_1.Referral.findByIdAndUpdate(id, {
      $unset: { referralFile: 1 },
    });
  });
exports.deleteReferralFileById = deleteReferralFileById;
const deleteFollowUpFileById = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    yield referral_model_1.Referral.findByIdAndUpdate(id, {
      $unset: { followUpLetterFile: 1 },
    });
  });
exports.deleteFollowUpFileById = deleteFollowUpFileById;
const deleteOutreachFileById = (id) =>
  __awaiter(void 0, void 0, void 0, function* () {
    yield referral_model_1.Referral.findByIdAndUpdate(id, {
      $unset: { outReachLetterFile: 1 },
    });
  });
exports.deleteOutreachFileById = deleteOutreachFileById;
const putFollowUpFileName = (id, name, key, type) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const updateItem = {};
...
const putOutreachFileName = (id, name, key, type) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const updateItem = {};
