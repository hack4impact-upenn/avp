...
exports.removeInviteByToken =
  exports.getInviteByToken =
  exports.getInviteByEmail =
 ...
 */
const createInvite = (email, verificationToken) =>
 ...
 * @returns The created {@link Invite}
 */
const updateInvite = (oldInvite, verificationToken) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const invite = yield invite_model_1.Invite.findOneAndUpdate(
      { email },
      newInvite,
    ).exec();
    return invite;
...
const getInviteByToken = (token) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const invite = yield invite_model_1.Invite.findOne({
 ...
 */
const removeInviteByToken = (token) =>
  __awaiter(void 0, void 0, void 0, function* () {
