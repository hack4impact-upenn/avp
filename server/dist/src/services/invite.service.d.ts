 ...
 */
declare const getInviteByEmail: (email: string) => Promise<
  IInvite &
    Required<{
      _id: string;
    }>
 ...
 * @returns The invite {@link Invite}
 */
declare const getInviteByToken: (token: string) => Promise<
  IInvite &
    Required<{
      _id: string;
    }>
 ...
 */
declare const removeInviteByToken: (token: string) => Promise<
  IInvite &
    Required<{
      _id: string;
    }>
