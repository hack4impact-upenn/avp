...
const inviteUser = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const existingInvite = yield (0, invite_service_1.getInviteByEmail)(lowercaseEmail);
    try {
        ...
        if (existingInvite) {
            ...
            yield (0, invite_service_1.createInvite)(lowercaseEmail, verificationToken);
        }
        yield (0, mail_service_1.emailInviteLink)(lowercaseEmail, verificationToken);
