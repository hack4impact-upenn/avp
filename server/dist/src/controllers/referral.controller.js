...
exports.uploadReferral =
  exports.deleteOutreachFile =
  exports.deleteFollowUpFile =
  exports.deleteReferralFile =
  exports.getOutreachFile =
  exports.createOutreachPDF =
  exports.getFollowUpFile =
  exports.createFollowUpPDF =
  exports.getReferralFile =
  exports.createRefferalPDF =
  exports.updateYouthServicesOutcome =
  exports.createYouthServicesOutcome =
  exports.getYouthServicesOutcome =
  exports.updateCounsellingServicesOutcome =
  exports.createCounsellingServicesOutcome =
  exports.getCounsellingServicesOutcome =
  exports.updateVictimServicesOutcome =
  exports.createVictimServicesOutcome =
  exports.getVictimServicesOutcome =
  exports.getDuplicates =
  exports.deleteHistory =
  exports.updateHistory =
  exports.addToHistory =
  exports.getCommunicationHistory =
  exports.updateReferral =
  exports.getReferral =
  exports.getDepartmentReferrals =
...
const setReferralStatus = (
  ...
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (establishedContact) {
      ...
      (historyOfCommunication === null || historyOfCommunication === void 0
        ? void 0
        : historyOfCommunication.length) === 1 &&
      !((_a = historyOfCommunication[0]) === null || _a === void 0
        ? void 0
        : _a.didEstablishedContact)
    ) {
      ...
      !((_b = historyOfCommunication[1]) === null || _b === void 0
        ? void 0
        : _b.didEstablishedContact)
    ) {
      ...
      !((_c = historyOfCommunication[2]) === null || _c === void 0
        ? void 0
        : _c.didEstablishedContact)
    ) {
...
const uploadReferral = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
      ...
      fs_1.default
        ...
        .on('data', (row) => {
          ...
          const newReferral = {
            ...
            transferredToCCWaitlist:
              row['Transferred to CC Waitlist?'] || false,
          ...
          // }
          promises.push(
            (0, referral_service_1.createNewReferral)(
...
const createReferral = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const status = yield setReferralStatus(
        staffAssigned,
        historyOfCommunication,
        outreachLetterSent,
        transferredToCCWaitlist,
...
const getDepartmentReferrals = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { department } = req.params;
    try {
      const referrals = yield (0, referral_service_1.getAllDepartmentReferrals)(
        department,
      );
      res.status(statusCode_1.default.OK).json(referrals);
    } catch (err) {
...
const getReferral = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
...
const buildYVOOutcomesString = (youthServicesOutcome) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const outcomes = [];
...
const updateReferral = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      ...
      const referral = yield (0, referral_service_1.updateReferralById)(
        id,
        status,
        departmentInCharge,
        program,
      ...
      const staffEmail =
        staffAssigned === null || staffAssigned === void 0
          ? void 0
          : staffAssigned.email;
      const staffNumber =
        staffAssigned === null || staffAssigned === void 0
      ...
      const staffFirstName =
        (staffAssigned === null || staffAssigned === void 0
          ? void 0
          : staffAssigned.firstName) || 'last name placeholder';
      const staffLastName =
        (staffAssigned === null || staffAssigned === void 0
          ? void 0
          : staffAssigned.lastName) || 'first name placeholder';
      const staffDepartment =
        staffAssigned === null || staffAssigned === void 0
          ? void 0
          : staffAssigned.department;
      const nameArr = survivorName.split(' ');
      const survivorInitials = `${nameArr[0].charAt(0)}${nameArr[
        nameArr.length - 1
      ].charAt(0)}`;
      if (
        status === 'Assigned' &&
        !(prevReferral === null || prevReferral === void 0
          ? void 0
...
const getCommunicationHistory = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    try {
      const referral = yield (0, referral_service_1.getReferralById)(id);
...
const addToHistory = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const referral = yield (0, referral_service_1.addToCommunicationHistory)(
        id,
...
const updateHistory = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const referral = yield (0, referral_service_1.updateCommunicationHistory)(
        id,
        index,
        dateOfCommunication,
        method,
...
const deleteHistory = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id, index } = req.params;
    try {
      const referral = yield (0, referral_service_1.deleteCommunicationHistory)(
        id,
        Number(index),
      );
      res.status(statusCode_1.default.OK).json(referral);
...
const getDuplicates = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
      const referrals = yield (0, referral_service_1.getDuplicateReferrals)(
        phoneNumber,
        email,
      );
      res.status(statusCode_1.default.OK).json(referrals);
...
const getVictimServicesOutcome = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _d;
    const { id } = req.params;
    try {
      const outcome =
        (_d = yield (0, referral_service_1.getReferralById)(id)) === null ||
        _d === void 0
          ? void 0
          : _d.victimServicesOutcome;
...
const createVictimServicesOutcome = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    let {
    ...
    try {
      const outcome = yield (0, referral_service_1.postVictimServicesOutcome)(
        id,
        eligibleForAVPVictimServices,
        sentVCAPInfotoClient,
        avpAdvocateAssistingWithVCAP,
...
const updateVictimServicesOutcome = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const {
      id,
      eligibleForAVPVictimServices,
    ...
    try {
      const outcome = yield (0, referral_service_1.putVictimServicesOutcome)(
        id,
        eligibleForAVPVictimServices,
        sentVCAPInfotoClient,
        avpAdvocateAssistingWithVCAP,
...
const getCounsellingServicesOutcome = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _e;
    const { id } = req.params;
    try {
      const outcome =
        (_e = yield (0, referral_service_1.getReferralById)(id)) === null ||
        _e === void 0
          ? void 0
          : _e.counsellingServicesOutcome;
      res.status(statusCode_1.default.OK).json(outcome);
    } catch (err) {
      next(
        apiError_1.default.internal(
...
const createCounsellingServicesOutcome = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    let {
    ...
    try {
      const outcome = yield (0,
      referral_service_1.postCounsellingServicesOutcome)(
        id,
        eligibleForAVPCounsellingServices,
        receivingCrisisCounselling,
        scheduledIntakeApptForIndividualTherapy,
...
const updateCounsellingServicesOutcome = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const {
      id,
      eligibleForAVPCounsellingServices,
    ...
    try {
      const outcome = yield (0,
      referral_service_1.putCounsellingServicesOutcome)(
        id,
        eligibleForAVPCounsellingServices,
        receivingCrisisCounselling,
        scheduledIntakeApptForIndividualTherapy,
...
const getYouthServicesOutcome = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _f;
    const { id } = req.params;
    try {
      const outcome =
        (_f = yield (0, referral_service_1.getReferralById)(id)) === null ||
        _f === void 0
          ? void 0
          : _f.youthServicesOutcome;
      res.status(statusCode_1.default.OK).json(outcome);
    } catch (err) {
      next(
        apiError_1.default.internal(
...
const createYouthServicesOutcome = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    let {
    ...
    try {
      const outcome = yield (0, referral_service_1.postYouthServicesOutcome)(
        id,
        eligibleForYVOServices,
        assignedToYVOTherapist,
        yvoStaffName,
...
const updateYouthServicesOutcome = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const {
      id,
      eligibleForYVOServices,
    ...
    try {
      const outcome = yield (0, referral_service_1.putYouthServicesOutcome)(
        id,
        eligibleForYVOServices,
        assignedToYVOTherapist,
        yvoStaffName,
...
const createRefferalPDF = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const getReferralFile = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const deleteReferralFile = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params;
...
const createFollowUpPDF = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const id = req.params.referral_id;
      if (
...
const getFollowUpFile = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const key = req.params.file_key;
      const resp = yield awsGet(key);
...
const deleteFollowUpFile = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params;
...
const createOutreachPDF = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const id = req.params.referral_id;
      if (
...
const getOutreachFile = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const key = req.params.file_key;
      const resp = yield awsGet(key);
...
const deleteOutreachFile = (req, res, next) =>
  __awaiter(void 0, void 0, void 0, function* () {
    try {
      const { id } = req.params;
