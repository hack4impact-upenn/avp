...
const createNewReferral = async (
  ...
  survivorGrade: number | undefined,
  survivorPreferredContactMethod: string,
  isGuardianResponsible: boolean | undefined,
  guardianName: string,
  ...
  homDecedentAge: number | undefined,
  ...
  historyOfCommunication: Array<communicationItem> | undefined,
